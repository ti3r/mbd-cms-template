...
class MBDAboutTeamBar(CMSPlugin):
    ...
    sections = models.PositiveSmallIntegerField(default=4, null= False, blank=False,
                                   ...
                                   help_text=_("Describe the number of sections the bar will be divided showing arrows "
...
class MBDBoardMemberCard(CMSPlugin):
    ...
    about page
    """
    name = models.CharField(null=False, blank=False,help_text=_("Main name to display on the card"),verbose_name=_("Name"),max_length=60)
    title = models.CharField(null=False, blank=False,help_text=_("Title of the board member"),verbose_name=_("Title"),max_length=60)
    bio = models.TextField(null=False, blank=False,help_text=_("Brief biography of the member"),verbose_name=_("Bio"))
    picture = FilerImageField(null=True, blank=True, default=None, verbose_name=_("image"), on_delete=models.SET_NULL, help_text=_("Member Picture"))
